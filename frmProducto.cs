...
namespace CapaPresentacion
{
    public partial class frmProducto : Form
    {
        ...
        private void frmProducto_Load(object sender, EventArgs e)
        {
            ...
            List<Categoria> listacategoria = new N_Categoria().Listar();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (obj.IdProducto == 0)
            {
                int idgenerado = new N_Producto().Registrar(obj, out mensaje);
            ...
            {
                bool resultado = new N_Producto().Editar(obj, out mensaje);
